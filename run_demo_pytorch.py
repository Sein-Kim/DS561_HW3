...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', default='data/model/pretrained/Seoul-Core/config.yaml', type=str,
                        help='Config file for pretrained model.')
    # parser.add_argument('--output_filename', default='data/dcrnn_predictions.npz')
    parser.add_argument('--output_filename', default='data/dcrnn_predictions_gcn.npz')
